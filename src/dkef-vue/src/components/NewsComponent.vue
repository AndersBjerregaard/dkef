      ...
      <div class="flex flex-col flex-1 p-4 gap-2">
        ...
        <p class="font-semibold line-clamp-2 leading-snug h-10 overflow-hidden">
         ...
         <div class="mt-auto flex flex-col gap-1 text-sm text-theme-text">
           ...
           <div v-if="props.publishedNews?.attachmentUrls?.length ?? 0 > 0" class="flex items-center gap-1 pt-2 text-xs">
             <svg
             ...
             <span>{{ props.publishedNews.attachmentUrls.length }} vedhæftelse(r)</span>
           </div>
         </div>
      </div>
    </div>
