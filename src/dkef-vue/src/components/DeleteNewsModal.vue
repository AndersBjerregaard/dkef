...
<template>
  <BaseModal :is-open="isOpen" title="Slet Nyhed" :is-loading="isLoading" @close="emit('close')">
    <p>Er du sikker på at du vil slette denne nyhed? Denne handling kan ikke fortrydes.</p>
